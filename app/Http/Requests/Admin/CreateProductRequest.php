...
class CreateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'variants.*.sizes' => 'required|array', // Kiểm tra rằng sizes là bắt buộc
    ...
    public function messages()
    {
        return [
            ...
            'variants.required' => 'Vui lòng nhập biến thể sản phẩm.',
            'variants.*.color_id.required' => 'Màu của biến thể là bắt buộc.',
            'variants.*.color_id.exists' => 'Màu của biến thể không hợp lệ.',
            'variants.*.sizes.required' => 'Vui lòng nhập biến thể kích thước.', // Thông báo cho sizes
            ...
            'price.required' => 'Giá cho mỗi biến thể là bắt buộc.',
