...
class ShopCollectionController extends Controller
{
    ...
    public function index($slug = null)
    {
        ...
        // Lấy danh sách tags (bộ sưu tập) có ảnh nền
        ...
        $products = Product::query()
            ...
            ->select([
                ...
                DB::raw('(SELECT SUM(stock_quantity) FROM product_variants WHERE product_variants.product_id = products.id) as total_stock_quantity') // Tổng tồn kho
            ])
            ->groupBy('products.id')
            ->paginate(15);
        ...
        return view('client.shop-collection', compact('categories', 'products', 'tags'));
    }
}
