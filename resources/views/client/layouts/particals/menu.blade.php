<nav class="box-navigation text-center">
    <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        @foreach ($categories as $category)
                            <div class="col-lg-2">
                                <div class="mega-menu-item">
                                    <div class="menu-heading fs-6">{{ $category->name }}</div>
                        ...
                        @endforeach
                        <div class="col-lg-4">
                            <div class="menu-heading">Sản phẩm bán chạy</div>
                            <div class="hover-sw-nav hover-sw-2">
                                <div class="swiper tf-product-header"> 
                                    <div class="swiper-wrapper">
                                        @foreach ($productsBestSaler as $product)
                                            <div class="swiper-slide" lazy="true">
                                                ...
                                                <span class="icon icon-check"></span>
                                                        ...
                                                        <div class="size-list">
                                                            <span>{{ $product['distinct_size_count'] }} sizes
                                                                available</span>
                                                        </div>
                                                    </div>
        ...
        <li class="menu-item position-relative">
            <a href="{{route('about-us')}}" class="item-link">Giới Thiệu</a>

        </li>
        <li class="menu-item position-relative">
            <a href="{{route('contact')}}" class="item-link">Liên Hệ</a>
