                                        ...
                                        <td class="tf-cart-item_quantity" cart-data-title="Quantity">
                                            <div class="cart-quantity">
                                                <div class="wg-quantity">
                                                    <span class="btn-quantity minus-btn-cart-2"
                                                    ...
                                                    <input type="text" class="quantity-input quantity-input-update"
                                                        name="number" value="{{ $item['quantity'] }}"
                                                        data-url="{{ route('cart.update') }}"
                                                        data-id="{{ $item['product_id'] }}"
                                                        data-color="{{ $item['color_id'] }}"
                                                        data-size="{{ $item['size_id'] }}">
                                                    <span class="btn-quantity plus-btn-cart-2"
                                                        data-url="{{ route('cart.update') }}"
                                                        data-id="{{ $item['product_id'] }}"
                                                        data-color="{{ $item['color_id'] }}"
                                                        data-size="{{ $item['size_id'] }}">
                    ...
                    <div class="tf-cart-footer-inner">
                        <div class="tf-page-cart-checkout">
                            ...
                            <div class="cart-continue-btn">
                                <a href="{{ route('home') }}"
                                    class="tf-btn w-100 btn-outline animate-hover-btn radius-3 justify-content-center">
