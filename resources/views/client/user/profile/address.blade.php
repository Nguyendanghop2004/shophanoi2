                ...
                <section class="flat-spacing-11">
                    ...
                    <div class="tf-page-title">
                        <div class="container-full">
                            <div class="heading text-center">Đỉa chi</div>
                        </div>
                    </div>
                    <!-- /page-title -->
                                        ...
                                        <div class="text-center widget-inner-address">
                                            ...
                                            <form class="show-form-address wd-form-address" id="formnewAddress"
                                                ...
                                                <div class="box-field">
                                                    <div class="tf-field style-1">
                                                        <input class="tf-field-input tf-input" placeholder=" "
                                                            type="text" id="AddressZipNew" name="AddressZipNew">
                                                        <label class="tf-field-label fw-4 text_black-2"
                                                ...
                                                <div class="box-field text-start">
                                                    <div
                                                        ...
                                                        <label for="check-new-address" class="text_black-2 fw-4">Set as
                                                ...
                                                <div class="d-flex align-items-center justify-content-center gap-20">
                                                    <button type="button" class="tf-btn btn-fill animate-hover-btn">Add
                                                        address</button>
                                                    <span
                                                        class="tf-btn btn-fill animate-hover-btn btn-hide-address">Cancel</span>
                                                </div>
                                            </form>
                                            ...
                                            <form class="edit-form-address wd-form-address" id="formeditAddress"
                                                action="#">
                                                <div class="title">Edit address</div>
                                                <div class="box-field grid-2-lg">
                                                    <div class="tf-field style-1">
                                                        <input class="tf-field-input tf-input" placeholder=" "
                                                            type="text" id="firstnameEdit" name="first name">
                                                        <label class="tf-field-label fw-4 text_black-2"
                                                            for="firstnameEdit">First name</label>
                                                    </div>
                                                    <div class="tf-field style-1">
                                                        <input class="tf-field-input tf-input" placeholder=" "
                                                            type="text" id="lastnameEdit" name="last name">
                                                        <label class="tf-field-label fw-4 text_black-2"
                                                ...
                                                <div class="box-field">
                                                    <div class="tf-field style-1">
                                                        <input class="tf-field-input tf-input" placeholder=" "
                                                            type="text" id="companyEdit" name="company">
                                                        <label class="tf-field-label fw-4 text_black-2"
                                                ...
                                                <div class="box-field">
                                                    <div class="tf-field style-1">
                                                        <input class="tf-field-input tf-input" placeholder=" "
                                                            type="text" id="addressEdit" name="address">
                                                        <label class="tf-field-label fw-4 text_black-2"
                                                ...
                                                <div class="box-field">
                                                    <div class="tf-field style-1">
                                                        <input class="tf-field-input tf-input" placeholder=" "
                                                            type="text" id="cityEdit" name="city">
                                                        <label class="tf-field-label fw-4 text_black-2"
                                                ...
                                                <div class="d-flex align-items-center justify-content-center gap-20">
                                                    <button type="button"
                                                        class="tf-btn btn-fill animate-hover-btn">Update address</button>
                                                    <span
