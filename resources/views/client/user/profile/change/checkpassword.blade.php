                ...
                <section class="flat-spacing-11">
                    ...
                    <div class="tf-page-title">
                        <div class="container-full">
                            <div class="heading text-center">Nhập Mật khẩu</div>
                        </div>
                    </div>
                    <!-- /page-title -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="my-account-content account-edit">
                                        <div class="">
                                            <form id="update-admin-form" action="{{route('account.StoreEmail',auth()->user()->id)}}" method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-12"> <!-- Địa chỉ cụ thể -->
                                                        ...
                                                        <div class="form-group">
                                                            <label for="phone_number">Nhập mật khẩu</label>
