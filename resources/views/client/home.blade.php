                        ...
                        @foreach ($collections as $collection)
                            <div class="collection-item-circle hover-img">
                                <a href="shop-collection-sub.html" class="collection-image img-style">
                                    <img class="lazyload" data-src="{{ asset('storage/' . $collection->background_image) }}"
                                        src="{{ asset('storage/' . $collection->background_image) }}" alt="collection-img">
                                </a>
                                <div class="collection-content text-center">
                                    <a href="shop-collection-sub.html" class="link title fw-6">{{ $collection->name }}</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="collection-item style-2 hover-img">
                            <div class="collection-inner">
                                ...
                                <div class="collection-content">
                                    <a href="" class="tf-btn collection-title hover-icon fs-15 rounded-full"><span>{{
                                            $category->name }}</span><i class="icon icon-arrow1-top-left"></i></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-product-wrapper">
                                    <a href="{{ route('product-detail', $product['slug']) }}" class="product-img">
                                        <img class="lazyload img-product"
                                            ...
                                            src="{{ asset('storage/' . $product['main_image_url']) }}" alt="image-product">
                                ...
                                <div class="card-product-info">
                                    ...
                                    <ul class="list-color-product">
                                        @foreach ($product['colors'] as $index => $color)
                                            <li class="list-color-item color-swatch @if ($index == 0) active @endif">
                                                ...
                                                <img class="lazyload image-product"
                                                    ...
                                                    src="{{ asset('storage/' . $color['main_image']) }}" alt="image-product">
                                                <img class="lazyload hover-image-product"
                                                    data-src="{{ asset('storage/' . $color['hover_image']) }}"
                                                    src="{{ asset('storage/' . $color['hover_image']) }}" alt="image-product">
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                            ...
                            <div class="blog-article-item">
                                ...
                                <div class="article-content">
                                    ...
                                    <div class="article-btn">
                                        <a href="{{route('blog.detail', $item->slug)  }}" class="tf-btn btn-line fw-6">Xêm
                                            Thêm<i class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="tf-grid-layout md-col-2 tf-img-with-text style-1">
            ...
            <div class="tf-content-wrap wow fadeInUp" data-wow-delay="0s">
                ...
                <a href="shop-collection-list.html" class="tf-btn style-2 btn-fill rounded-full animate-hover-btn">Read
                    our stories</a>
            </div>
        </div>
    </div>
                            ...
                            <div class="grid-img-group style-ter-1">
                                <div class="box-img item-1 hover-img">
                                    <div class="img-style">
                                        <img class="lazyload"
                                            data-src="{{ asset('client/assets/images/slider/te4.jpg') }}"
                                            src="{{ asset('client/assets/images/slider/te4.jpg') }}" alt="img-slider">
                                    </div>
                                </div>
                                <div class="box-img item-2 hover-img">
                                    <div class="img-style">
                                        <img class="lazyload"
                                            ...
                                            src="{{ asset('client/assets/images/slider/te3.jpg') }}" alt="img-slider">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid-img-group style-ter-1">
                                <div class="box-img item-1 hover-img">
                                    <div class="img-style">
                                        <img class="lazyload"
                                            data-src="{{ asset('client/assets/images/slider/te6.jpg') }}"
                                            src="{{ asset('client/assets/images/slider/te6.jpg') }}" alt="img-slider">
                                    </div>
                                </div>
                                <div class="box-img item-2 hover-img">
                                    <div class="img-style">
                                        <img class="lazyload"
                                            ...
                                            src="{{ asset('client/assets/images/slider/te5.jpg') }}" alt="img-slider">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<section class="flat-spacing-12">
    <div class="container">
        <div class="swiper tf-sw-brand border-0" data-play="true" data-loop="true" data-preview="6" data-tablet="4"
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="tag-item">
                        <!-- Ảnh bộ sưu tập -->
                        <img src="{{ asset('storage/' . $tag->background_image) }}" alt="{{ $tag->name }}"
                            class="tag-image">
