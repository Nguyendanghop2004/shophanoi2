    ...
    <section class="section">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h4>Sửa mã giảm giá mới</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.discount_codes.update', $discountCode->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" 
                                    value="{{ $discountCode->code }}" placeholder="Nhập mã giảm giá">
                                @error('code')
                            ...
                            <div class="form-group">
                                ...
                                <select name="discount_type" id="discount_type" class="form-control @error('discount_type') is-invalid @enderror">
                                    ...
                                    <option value="fixed"  {{ $discountCode->discount_type == 'fixed' ? 'selected' : '' }}>Cố định</option>
                                </select>
                                @error('discount_type')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                value="{{ $discountCode->discount_value }}" placeholder="Nhập giá trị giảm giá">
                            ...
                            <div class="form-group">
                                ...
                                value="{{ $discountCode->usage_limit }}" placeholder="Không giới hạn nếu để trống">
                                @error('usage_limit')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_ids[]" id="user_ids" class="form-control select2 @error('user_ids') is-invalid @enderror" multiple>
                                    ...
                                    <option value="{{ $user->id }}" {{ $discountCode->userLimits->pluck('user_id')->contains($user->id) ? 'selected' : '' }}>
                                        {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_ids[]" id="product_ids" class="form-control select2 @error('product_ids') is-invalid @enderror" multiple>
                                    ...
                                    <option value="{{ $product->id }}" {{ $discountCode->products->pluck('product_id')->contains($product->id) ? 'selected' : '' }}>
